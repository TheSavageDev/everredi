...
const unchartedTemplates: UnchartedTemplate[] = [
  ...
  // Kits below have no itemized contents on their product pages (marketing copy only, no
  // machine-readable “what’s inside” list). Fill items manually from the link or when Uncharted
  // publishes a contents list.
  {
    ...
    price: 79,
    // Quantities approximate from List Contents / product photos.
    items: [
      { supplyName: 'Shears', quantity: 1 },
      { supplyName: 'Gauze Pads', quantity: 1 },
      { supplyName: 'Triple Antibiotic', quantity: 1 },
      { supplyName: 'Mylar Blanket', quantity: 1 },
      { supplyName: 'First Aid Guide & Notebook', quantity: 1 },
      { supplyName: 'Permanent Marker', quantity: 1 },
      { supplyName: 'Splinter Probes', quantity: 4 },
      { supplyName: 'Triangular Bandage', quantity: 1 },
      { supplyName: 'Compressed Gauze', quantity: 2 },
      { supplyName: 'Tweezers', quantity: 1 },
      { supplyName: 'Burn Cream', quantity: 1 },
      { supplyName: 'Blister Gels', quantity: 5 },
      { supplyName: 'Slishman Pressure Bandage', quantity: 1 },
      { supplyName: 'Adhesive bandages (1x3 inches)', quantity: 6 },
      { supplyName: 'Wound Closure Stripes', quantity: 3 },
      { supplyName: 'Antihistamine Sachet', quantity: 2 },
      { supplyName: 'Nitrile Gloves', quantity: 1 },
      { supplyName: 'Safety Pins', quantity: 6 },
      { supplyName: 'Aspirin', quantity: 2 },
      { supplyName: 'Hypo-allergenic Medical Tape', quantity: 1 },
      { supplyName: 'Adhesive bandages (2x4 inches)', quantity: 5 },
      { supplyName: 'Ibuprofen Sachet', quantity: 2 },
      { supplyName: 'CPR Kit', quantity: 1 },
      { supplyName: 'Saline Tube (30mL)', quantity: 1 },
    ],
  },
  {
    ...
    price: 59,
    items: [
      { supplyName: 'Stormproof Matches', quantity: 10 },
      { supplyName: 'Adhesive bandages (1x3 inches)', quantity: 6 },
      { supplyName: 'Blister Pads', quantity: 5 },
      { supplyName: 'Zip Ties - 7 inches', quantity: 4 },
      { supplyName: 'Adhesive bandages (2x4 inches)', quantity: 2 },
      { supplyName: 'Safety Pins', quantity: 3 },
      { supplyName: 'Aspirin', quantity: 2 },
      { supplyName: 'Lube Jelly', quantity: 4 },
      { supplyName: 'Wound Closure Stripes', quantity: 2 },
      { supplyName: 'Flat Pack Duct Tape', quantity: 1 },
      { supplyName: 'Bailing Wire', quantity: 1 },
      { supplyName: 'Carrying Pouch', quantity: 1 },
      { supplyName: 'Mylar Blanket', quantity: 1 },
    ],
  },
  {
    ...
    items: [
      { supplyName: 'Nitrile Gloves', quantity: 2 },
      { supplyName: 'Shears', quantity: 1 },
      { supplyName: 'CPR Mask', quantity: 1 },
      { supplyName: 'Safety Pins', quantity: 2 },
      { supplyName: 'Non-Adhesive Cotton Gauze Sponges', quantity: 2 },
      { supplyName: 'Splinter Probes', quantity: 1 },
      { supplyName: 'Antiseptic Wipes', quantity: 3 },
      { supplyName: 'Tweezers', quantity: 1 },
      { supplyName: 'Conforming Bandage', quantity: 1 },
      { supplyName: 'Medical Tape', quantity: 1 },
      { supplyName: 'Adhesive bandages (2x4 inches)', quantity: 8 },
      { supplyName: 'Adhesive Bandages 4x4', quantity: 2 },
    ],
  },
  {
    ...
    items: [
      { supplyName: 'Gauze Pads (3x3 inches)', quantity: 2 },
      { supplyName: 'Alcohol Wipes', quantity: 3 },
      { supplyName: 'Reusable Zip Ties', quantity: 2 },
      { supplyName: 'Nitrile Gloves', quantity: 1 },
      { supplyName: 'Forceps', quantity: 1 },
      { supplyName: 'Dog Waste Bags', quantity: 1 },
      { supplyName: 'Cohesive Bandage', quantity: 1 },
      { supplyName: 'Triple Antibiotic', quantity: 1 },
